...
import { addToCart, removeFromCart } from '../features/product/cartSlice';
  ...
  const handleCartClick = async (productId) => {
    ...
    if (cartItem) {
      ...
      if (userConfirmed) {
        ...
        toast.success(`${product.productName} has been removed from the cart!`, {
      ...
      toast.success(`${product.productName} has been added to the cart!`, {
        className: 'toast-custom' // Apply custom class for addition
      });
    }
  };
